...
OSBos::OSBos(uint8_t numThreads){
  ...
  //_threads = (Thread**)malloc(numThreads * sizeof(Thread*)); // apparently I can do this with "new"?? Keeping this here for a tad in case it doesn't work because I didn't know you could do that here.
